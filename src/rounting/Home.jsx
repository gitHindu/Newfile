    ...
    <>
      ...
      <div id="about-section" className="p-5 py-5 bg-color">
        <div className="bg-color-outside p-5">
          <h2 className="mb-3 text-white ">About</h2>
          <div className="row container-fluid new-section d-flex px-5 justify-content-between align-items-center">
          ...
          <div className="col-md-6 mt-5">
            <div className="row card-my">
              ...
              <div className="col-md-9">
                <h5 className="text-white mt-2">Software Engineer, Finbot</h5>
        ...
        <div className="row mt-5">
          <div className="col-md-4 mt-3">
            <div className="p-4 bg-color-outside">
              ...
              <div className="one_button">
                <Link to="/Demo">
                  <button className="my-btn m-0 btn mb-2 btn-primary">Demo</button>
                </Link>
                <div>
          ...
          <div className="col-md-4 mt-3">
            <div className="p-4 bg-color-outside">
              ...
              <div className="one_button">
                <Link to="/Demo">
                  <button className="my-btn m-0 mb-2 btn btn-primary">Demo</button>
                </Link>
                <div>
          ...
          <div className="col-md-4 mt-3">
            <div className="p-4 bg-color-outside">
              ...
              <div className="one_button">
                <Link to="/Tier">
                  <button className="my-btn  mb-2 m-0 btn btn-primary">Demo</button>
                </Link>
                <div>
